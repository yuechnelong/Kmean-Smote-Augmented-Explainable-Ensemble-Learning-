function [Mdl,fMin,Convergence_curve]  = optimize_fitrtree(train_x_feature_label_norm,train_y_feature_label_norm,vaild_x_feature_label_norm,vaild_y_feature_label_norm,num_pop,num_iter,method_mti)
...
disp('优化超参数为:')
disp([method_mti, '优化 fitrtree:   ',"MinLeafSize:",num2str(round(pos(1)))])
disp('_________________________')
end
function [fitness_value,Mdl]=fit_fitrtree(pop,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
%    global train_x_feature_label_norm train_y_feature_label_norm vaild_x_feature_label_norm vaild_y_feature_label_norm
    Mdl= fitrtree(train_x_feature_label_norm,train_y_feature_label_norm,"MinLeafSize",round(pop(1)));  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
  ...
  for j = round( pop *  0.6 )+1 : pop                 % Equation (7)
      ...
      [fit( j ),model{1,j}] = fobj( x( i, : ),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm ) ;    
  end
...
%% 模拟退火
%[gBestScore,Mdl_best,cg_curve,gBest]=PSO_PSO(N,Max_iteration,lb,ub,dim,fobj, train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
